...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($email) || empty($role) || empty($firstName) || empty($lastName)) {
        ...
        if ($stmt->fetch()) {
            ...
            try {
                // Update user
                $sql = "UPDATE users SET username = ?, email = ?, role = ?, first_name = ?, last_name = ?, middle_name = ?, is_active = ?";
                $params = [$username, $email, $role, $firstName, $lastName, $middleName, $isActive];
                ...
                setFlashMessage('Error updating user: ' . $e->getMessage(), 'danger');
            }
        }
    }
}
    ...
    <div class="main-content">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit User Information</h5>
            </div>
            <div class="card-body">
