...
if (isset($_GET['delete'])) {
    ...
    try {
        ...
        $db->rollBack();
        setFlashMessage('Error deleting student: ' . $e->getMessage(), 'danger');
    }
...
$sectionFilter = getParam('section', '');
$strandFilter = getParam('strand', '');

$sql = "SELECT s.*, u.email, u.is_active, u.first_name, u.last_name, u.middle_name,
...
$sql .= " ORDER BY s.grade_level, s.section, u.last_name, u.first_name";
...
$sections = $db->query("SELECT DISTINCT section FROM students ORDER BY section")->fetchAll(PDO::FETCH_COLUMN);
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form method="GET" class="row g-3">
                    <div class="col-md-3">
                        <input type="text" name="search" class="form-control" placeholder="Search by name or LRN..." value="<?php echo htmlspecialchars($search); ?>">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <select name="section" class="form-select">
                            ...
                            <?php foreach ($sections as $section): ?>
                                <option value="<?php echo $section; ?>" <?php echo $sectionFilter == $section ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-2">
                        <select name="strand" class="form-select">
                            ...
                            <?php foreach ($strands as $strand): ?>
                                <option value="<?php echo $strand; ?>" <?php echo $strandFilter == $strand ? 'selected' : ''; ?>>
                            ...
                            <?php else: ?>
                                <?php foreach ($students as $student): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-info"><?php echo htmlspecialchars($student['section']); ?></span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <a href="?delete=<?php echo $student['id']; ?>" 
                                                   ...
                                                   onclick="return confirm('Are you sure you want to delete this student? This will also delete their user account.')"
                                                   title="Delete">
